...
##Valores de z a evaluar
zs = [0.1091, 0.1895, 0.271, 0.368, 0.1343]     #(en metros) Distancia entre pantalla y abertura
...
for idx, z in enumerate(zs):
    ...
    if idx==0:
        ...
        tifffile.imwrite(r"C:\Users\pauli\OneDrive\Documents\Universidad\Instrumentos ópticos\practica1\imagenes practica1\simulacion\pez1.tif", grafico.astype(np.uint8))
    elif idx==2:
        tifffile.imwrite(r"C:\Users\pauli\OneDrive\Documents\Universidad\Instrumentos ópticos\practica1\imagenes practica1\simulacion\pez2.tif", grafico.astype(np.uint8))
    elif idx==3:
